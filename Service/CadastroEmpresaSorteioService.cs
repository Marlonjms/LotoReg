...
{
    public class CadastroEmpresaSorteioService : ICadastroEmpresaSorteio
    {
        private readonly string _stringConexao;

        public CadastroEmpresaSorteioService(IConfiguration configuracao)
        {
        ...
        public async Task<BuscarEmpresaSorteio?> ObterEmpresa(int idUsuario)
        {
            ...
            await using (var reader = await cmdEmpresa.ExecuteReaderAsync())
            {
                ...
                {
                    empresa = new BuscarEmpresaSorteio
                    {
