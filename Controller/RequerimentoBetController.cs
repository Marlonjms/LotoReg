...
namespace LotoReg.Controller
{
    ...
    [ApiController]
    [Authorize] 
    public class RequerimentoBetController : ControllerBase
    {
        private readonly IRequerimentoBet _requerimentoService;

        public RequerimentoBetController(IRequerimentoBet requerimentoService)
        {
